<?php
	...
	// FOR ONLINE
	$mcFileManagerConfig['preview.wwwroot'] = $_SERVER['DOCUMENT_ROOT']; // absolute or relative from this script path (c:/Inetpub/wwwroot)
	...
	$mcFileManagerConfig['filesystem.path'] = "../../../upload_files/"; // absolute or relative from this script path.
    $mcFileManagerConfig['filesystem.rootpath'] = "../../../upload_files/"; // absolute or relative from this script path.
	...
	// Authenication
	$mcFileManagerConfig['authenticator'] = "BaseAuthenticator";//SessionAuthenticator
